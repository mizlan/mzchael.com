  ...
  return (
    <main className="flex flex-col gap-4 px-10 sm:px-[15vw] lg:px-[30vw] mb-10">
      <section className="flex flex-col gap-3">
        <h1 className="text-3xl font-black font-generalsans uppercase">This Site</h1>
        <p>
          This site was made with Next.js and Tailwind! The colors were generated using
          {' '}
          <a className="underline" href="https://huewind.jordantwells.com">HueWind</a>. The source code is available
          {' '}
          <a className="underline" href="https://github.com/mizlan/mzchael.com/">here</a>.
        </p>
      </section>
      <section className="flex flex-col gap-3">
        <h2 className="text-xl font-black font-generalsans uppercase">Music Player Widget</h2>
        <p>
          The music player widget on the homepage is powered by <a className="underline" href="https://github.com/mizlan/recenttrack">recenttrack</a>, a
        ...
        <p>
          ...
          {' '}
          <a className="underline" href="https://www.last.fm/api">last.fm API</a>
          {' '}
