...
const Navigation = () => {
  return (
    <NavigationMenu.Root className={`uppercase font-generalsans font-medium text-md tracking-wide flex flex-row justify-between items-start gap-12 mt-5 mb-10 md:items-center lg:justify-end px-10 md:px-20 lg:px-32`}>
